...
public class UpsertRepoStrategyTests
{
    ...
    public async Task Execute_WhenExistingEntityFound_ExecutesUpdateFlow()
    {
        ...
        repoContext.Calls.LastUpdateRequest.ShouldNotBeNull();
        repoContext.Calls.LastUpdateRequest.CancellationToken.ShouldBe(TestContext.Current.CancellationToken);
    ...
    public async Task Execute_WhenExistingEntityNotFound_ExecutesCreateFlow()
    {
        ...
        repoContext.Calls.LastCreateRequest.ShouldNotBeNull();
        repoContext.Calls.LastCreateRequest.CancellationToken.ShouldBe(TestContext.Current.CancellationToken);
