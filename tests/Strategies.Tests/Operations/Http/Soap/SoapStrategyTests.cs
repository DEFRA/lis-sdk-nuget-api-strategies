...
public class SoapStrategyTests
{
    private const string TestSchemaEmbeddedResource =
        "Defra.Livestock.Sdk.Api.Strategies.Tests.TestFramework.Data.Soap.Schemas.EmbeddedTestSchema.xsd";

    private static readonly string TestSchemaFilePath =
        Path.Combine(AppContext.BaseDirectory, "TestFramework/Data/Soap/Schemas/FileTestSchema.xsd");
