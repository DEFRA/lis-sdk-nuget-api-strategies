...
public class OperatorContextTests
{
    ...
    public void SetAuthenticatedOperatorById_WhenValidId_SetsOperatorAndReturnsSelf()
    {
        ...
        context.Operator.ShouldSatisfyAllConditions(
            x => x.Id.ShouldBe("op-123"),
    ...
    public void SetOperatorByClaimsPrincipal_WhenValidClaims_SetsOperatorAndReturnsSelf()
    {
        ...
        context.Operator.ShouldSatisfyAllConditions(
            x => x.Id.ShouldBe("user-456"),
            x => x.Name.ShouldBe("John Doe"),
            x => x.Email.ShouldBe("john.doe@example.com"),
            x => x.Roles.ShouldBe(["Admin", "User"]),
            x => x.IsAuthenticated.ShouldBeTrue());
    }
    ...
    public void SetOperatorByClaimsPrincipal_WhenIdentityIsNull_SetsAuthenticatedToFalse()
    {
        ...
        principal.FindFirst(ClaimTypes.NameIdentifier)
            .Returns(new Claim(ClaimTypes.NameIdentifier, "id-null-identity"));
