...
public class GetPagedRepoStrategyTests
{
    ...
    public async Task Execute_FullSuccessfulFlow_ExecutesLifecycleInOrderAndReturnsPagedEntities()
    {
        ...
        repoContext.Calls.LastGetPagedRequest.ShouldNotBeNull();
        repoContext.Calls.LastGetPagedRequest.CancellationToken.ShouldBe(TestContext.Current.CancellationToken);
