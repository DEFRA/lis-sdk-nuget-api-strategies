...
public class SoapSerializerTests
{
    ...
    {
        // Act & Assert
        var ex = Should.Throw<InvalidOperationException>(() => SoapSerializer.DeserializeFromXElement<TestEntity>(null));
    ...
    public void DeserializeFromXElement_WhenNilElement_ShouldThrowInvalidOperationException()
    {
        ...
        // Act & Assert
        var ex = Should.Throw<InvalidOperationException>(() => SoapSerializer.DeserializeFromXElement<TestEntity>(nilElement));
        ex.Message.ShouldBe("Failed to deserialize XElement to object");
    }
}
