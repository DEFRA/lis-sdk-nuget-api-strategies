...
public class GetListRepoStrategyTests
{
    ...
    public async Task Execute_WhenNoEntitiesMatchFilter_ReturnsEmptyList()
    {
        ...
        repoContext.Calls.LastGetListRequest.ShouldNotBeNull();
        repoContext.Calls.LastGetListRequest.CancellationToken.ShouldBe(TestContext.Current.CancellationToken);
