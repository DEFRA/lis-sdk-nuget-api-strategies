    ...
    where TEntity : class
{
    ...
    public MockRepoContext<TEntity> WithData(TEntity[] entities)
    {
        ...
        TEntity? SetFilteredDataForGetSingle(CallInfo callInfo)
        {
            ...
            Calls.LastGetRequest =
                new MockRepoCallInfo() { CancellationToken = (CancellationToken)callInfo.Args()[1] };
        ...
        PagedEntities<TEntity> SetFilteredDataForGetPaged(CallInfo callInfo)
        {
            ...
            Calls.LastGetPagedRequest =
                new MockRepoCallInfo() { CancellationToken = (CancellationToken)callInfo.Args()[5] };
