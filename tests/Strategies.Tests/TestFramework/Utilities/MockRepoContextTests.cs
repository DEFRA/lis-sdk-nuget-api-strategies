...
public class MockRepoContextTests
{
    ...
    public async Task GetSingle_WhenMatchingEntityExists_ReturnsEntityAndUpdatesCalls()
    {
        ...
        // Act
        var result = await repository.GetSingle(x => x.Id == "2", cts.Token);

        // Assert
        result.ShouldBe(entity2);

        context.Calls.ShouldSatisfyAllConditions(
            x => x.GetCallCount.ShouldBe(1),
            x => x.LastGetResult.ShouldBe(entity2),
            x => x.LastGetRequest.ShouldNotBeNull(),
            x => x.LastGetRequest!.CancellationToken.ShouldBe(cts.Token));
    }
    ...
    public async Task GetSingle_WhenNoMatchingEntity_ReturnsNullAndUpdatesCalls()
    {
        ...
        // Act
        var result = await repository.GetSingle(x => x.Id == "999", cts.Token);
    ...
    public async Task GetList_WhenCalled_ReturnsMatchingEntitiesAndUpdatesCalls()
    {
        ...
        // Act
        var result = await repository.GetList(x => x.Name == "Alpha", cts.Token);
        ...
        context.Calls.ShouldSatisfyAllConditions(
            ...
            x => x.LastGetListResult.ShouldBe([entity1, entity3]),
            x => x.LastGetListRequest.ShouldNotBeNull(),
            x => x.LastGetListRequest!.CancellationToken.ShouldBe(cts.Token));
    }
    ...
    public async Task GetPaged_WhenAscending_OrdersAndPaginatesCorrectly()
    {
        ...
        context.Calls.ShouldSatisfyAllConditions(
            ...
            x => x.LastGetPagedResult.ShouldBe(page2),
            x => x.LastGetPagedRequest.ShouldNotBeNull(),
            x => x.LastGetPagedRequest!.CancellationToken.ShouldBe(cts2.Token));
    }
    ...
    public async Task GetPaged_WhenDescending_OrdersDescendingCorrectly()
    {
        ...
        context.Calls.ShouldSatisfyAllConditions(
            ...
            x => x.LastGetPagedRequest.ShouldNotBeNull(),
            x => x.LastGetPagedRequest!.CancellationToken.ShouldBe(cts.Token));
    }
    ...
    public async Task Update_WhenCalled_ReturnsInputEntityAndUpdatesCalls()
    {
        ...
        // Act
        var result = await repository.Update(entity, cts.Token);
        ...
        context.Calls.ShouldSatisfyAllConditions(
            ...
            x => x.LastUpdateResult.ShouldBe(entity),
            x => x.LastUpdateRequest.ShouldNotBeNull(),
            x => x.LastUpdateRequest!.CancellationToken.ShouldBe(cts.Token));
    }
    ...
    public async Task Create_WithStringId_ReturnsEntityAndUpdatesCalls()
    {
        ...
        // Act
        var result = await repository.Create(entity, cts.Token);
        ...
        context.Calls.ShouldSatisfyAllConditions(
            ...
            x => x.LastCreateResult.ShouldBe(entity),
            x => x.LastCreateRequest.ShouldNotBeNull(),
            x => x.LastCreateRequest!.CancellationToken.ShouldBe(cts.Token));
    }
    ...
    public async Task Create_WithGuidEntityExistingId_DoesNotOverwriteId()
    {
        ...
        result.Name.ShouldBe("ExistingId");
